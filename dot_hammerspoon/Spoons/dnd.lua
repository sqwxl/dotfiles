local secrets = require("Spoons/secrets")
...
function checkFocusMode()
	...
	if not file then
		print("⚠ Cannot read Focus mode status - Assertions.json does not exist yet")
		print("   Enable Focus mode once from Control Center to create the file")
		return
	end
