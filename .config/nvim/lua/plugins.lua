...
require'packer'.startup(function()
    ...
    use {
        ...
        config = function()
            require'nvim-tree'.setup {hijack_cursor = true, diagnostics = {enable = true}, view = {signcolumn = "no"}}
        end
    }
    ...
    use {
        ...
        config = function() require'toggleterm'.setup {open_mapping = '<A-Space>', shade_terminals = false} end
    }
    use {
