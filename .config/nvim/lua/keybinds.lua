...
map('n', '<leader>sf', [[<cmd>lua require('telescope.builtin').find_files()<CR>]], noremap_silent)
...
map('n', '<leader>st', [[<cmd>lua require('telescope.builtin').tags()<CR>]], noremap_silent)
map('n', '<leader>ss', [[<cmd>lua require('telescope.builtin').grep_string()<CR>]], noremap_silent)
map('n', '<leader>sl', [[<cmd>lua require('telescope.builtin').live_grep()<CR>]], noremap_silent)
map('n', '<leader>so', [[<cmd>lua require('telescope.builtin').tags{ only_current_buffer = true }<CR>]], noremap_silent)
