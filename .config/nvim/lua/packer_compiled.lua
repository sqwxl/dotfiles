...
_G.packer_plugins = {
  ...
  ["fidget.nvim"] = {
    ...
    loaded = true,
    path = "/home/nilueps/.local/share/nvim/site/pack/packer/start/fidget.nvim",
  ...
  ["nvim-cmp"] = {
    loaded = true,
    path = "/home/nilueps/.local/share/nvim/site/pack/packer/start/nvim-cmp",
  ...
  ["vim-endwise"] = {
    loaded = true,
    path = "/home/nilueps/.local/share/nvim/site/pack/packer/start/vim-endwise",
