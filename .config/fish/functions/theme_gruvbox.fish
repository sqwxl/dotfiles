...
function __theme_gruvbox_palette
  ...
  __printf_color 124 'cc/24/1d'
  __printf_color 106 '98/97/1a'
  __printf_color 172 'd7/99/21'
  __printf_color 66 '45/85/88'
  __printf_color 132 'b1/62/86'
  __printf_color 72 '68/9d/6a'
  __printf_color 166 'd5/5d/0e'
