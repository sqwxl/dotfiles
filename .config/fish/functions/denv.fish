function denv
    ...
    argparse --name=denv -x 'u,x' 'u/unset' 'h/help' 'x/export' 'q/quiet' -- $argv
    ...
    # This function will be available to be called directly from the shell, even though it is defined inside of denv.
    ...
    function __help_denv
      echo "Usage: denv [-u] [files]"
